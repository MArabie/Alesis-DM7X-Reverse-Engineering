...
With the right adapter, 1/4" Female TRS to Dual 1/4" Male TS splitter, and a Female to Male (TRS or TS) extension, it is possible to split Tom 1, Tom 2, Tom 3 and Ride from the original kit. You can split Tom 4 and Crash 2 as well depending on if you get the expansion kit or loose parts (ebay).
