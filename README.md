...
<br/>Unplug the TRS cable from a single zone durm/cymbal, plug in the spliiter, plug the Tip TS back into the single zone durm/cymbal, plug the extention into the Ring TS, then plug the TRS/TS extention into the additional single zone durm/cymbal.
...
| Trigger label on snake connector | Length (inches) | Symbol in diagram | Sleeve(S) Ring(R) Tip(T) | Pin |
| ------------- | ------------- | ------------- | ------------- | ------------- |
| snare | 22 | SD | S | 21 | 
|  |  |  | R | 8 |
|  |  |  | T | 9 |
